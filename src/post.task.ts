...
// TODO BLOCK `post` or `item`? maybe `post` and `note` are both `items`? where do terms and pages fit in?

const Args = z
	.object({
		url: z
			.string({description: 'full URL to the post directory'})
			.default('https://log.ryanatkn.com/post'),
